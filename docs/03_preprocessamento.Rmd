...
Após o tratamento, os dados serão analisados e comparados com as informações originais do site Climate TRACE, a fim de verificar a consistência e a qualidade do processamento.

Ao buscar o município de "Jaboticabal" na plataforma Climate TRACE, são apresentadas várias categorias de dados, referentes às emissões de gases de efeito estufa em diferentes níveis geográficos e fontes.
...
emissions_sources |> 
  dplyr::filter(
    source_name == "Jaboticabal" | muni == "Jaboticabal",
    year == 2021,
...
emissions_sources_forestry |>
  ...
  tidyr::drop_na() |>
  ggplot2::ggplot(ggplot2::aes(x =emissions_quantity, y=..density.., fill=biome_sig)) +
  ggplot2::geom_histogram(boundary=0, color="black",
                          bins = 100) +
  ggplot2::facet_wrap(~biome_sig)+
  ggplot2::theme_bw()
```
...
emissions_sources_forestry |>
  ...
  tidyr::drop_na() |>
  ggplot2::ggplot(ggplot2::aes(x =activity, y=..density.., fill=biome_sig)) +
  ggplot2::geom_histogram(boundary=0, color="black",
                          bins = 50) +
  ggplot2::facet_wrap(~biome_sig)+
  ggplot2::theme_bw()
...
emissions_sources_forestry |>
  ...
  tidyr::drop_na() |>
  ggplot2::ggplot(ggplot2::aes(x =emissions_factor, y = ..density.. ,fill=biome_sig)) +
  ggplot2::geom_histogram(boundary=0, color="black",
                          bins = 50) +
  ggplot2::facet_wrap(~biome_sig)+
  ggplot2::theme_bw()
...
emissions_sources_forestry |>
  ...
  tidyr::drop_na() |>
  ggplot2::ggplot(ggplot2::aes(x =capacity, y=..density.., fill=biome_sig)) +
  ggplot2::geom_histogram(boundary=0, color="black",
                          bins = 100) +
  ggplot2::facet_wrap(~biome_sig)+
  ggplot2::theme_bw()
...
emissions_sources_forestry |>
  ...
  tidyr::drop_na() |>
  ggplot2::ggplot(ggplot2::aes(x =capacity_factor, y=..density..,fill=biome_sig)) +
  ggplot2::geom_histogram(boundary=0, color="black",
                          bins = 50) +
  ggplot2::facet_wrap(~biome_sig)+
  ggplot2::theme_bw()
